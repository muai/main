...
{
    public partial class AdminCabinet : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            clientIDPassed = Convert.ToInt32(TextBox8.Text);
            ...
            Button12.Attributes.Add("onmouseover", "javascript:changeStyMOver('Button12');");
            Button12.Attributes.Add("onmouseout", "javascript:returnStyMOut('Button12');");
            Button13.Attributes.Add("onmouseover", "javascript:changeStyMOver('Button13');");
            Button13.Attributes.Add("onmouseout", "javascript:returnStyMOut('Button13');");
        }
        ...
        protected void createTariff(object sender, EventArgs e)
        {
            hideCtrl();
            Label5.Visible = true;
            Label8.Visible = true;
        ...
        protected void createService(object sender, EventArgs e)
        {
            hideCtrl();
            TextBox9.Visible = true;
            TextBox10.Visible = true;
        ...
        protected void insertService(object sender, EventArgs e)
        {
            try
            {
                услуга newService = new услуга()
                {
                    ИД_пользователя = 1,
                    ИД_услуги = newServiceID,
                    Название = TextBox9.Text,
                    Описание = TextBox10.Text,
                    Дата_созд = DateTime.Now,
                    Тип1 = Convert.ToInt32(DropDownList5.SelectedValue),
                    Тип2 = Convert.ToInt32(TextBox11.Text),
                    Дата_начало = Convert.ToDateTime(TextBox12.Text),
                    Дата_конец = Convert.ToDateTime(TextBox13.Text)
                };
                MUAI_DBContext.услуга.Add(newService);
        ...
        protected void insertTariff(object sender, EventArgs e)
        {
            try
            {
                тариф newService = new тариф()
                {
                    ИД_пользователя = 1,
                    ИД_тарифа = newServiceID,
                    Название = TextBox9.Text,
                    Описание = TextBox10.Text,
                    Тип1 = Convert.ToInt32(DropDownList5.SelectedValue),
                    Тип2 = Convert.ToInt32(TextBox11.Text),
                };
                MUAI_DBContext.тариф.Add(newService);
                MUAI_DBContext.SaveChanges();
