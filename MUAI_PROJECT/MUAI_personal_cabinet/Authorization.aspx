<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Authorization.aspx.cs" Inherits="MUAI_personal_cabinet.Authorization" %>
...
<body>
    ...
    <div>
        ...
        <p>
            &nbsp;</p>
        <div style="width:226px; margin-left:auto; margin-right:auto;" >
        <asp:Login ID="Login1" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" CssClass="auto-style3" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" Height="133px" OnAuthenticate="Login1_Authenticate" Width="226px">
            ...
            <LayoutTemplate>
                <table cellpadding="4" cellspacing="0" style="border-collapse:collapse;">
                    <tr>
                        <td>
                            <table cellpadding="0" style="height:133px;width:226px;" dir="auto" margin: "auto">
                                <tr>
