<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cabinet.aspx.cs" Inherits="MUAI_personal_cabinet.WebForm1" %>
...
<body style="height: 571px; width: 1136px; margin-right: 0px;">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" BackColor="White" BorderStyle="None" CssClass="auto-style1" Font-Bold="False" Font-Names="Corbel" Font-Size="Large" Font-Underline="False" ForeColor="Black" Text="Просмотр данных" Width="195px" style="position:absolute;left:-18px;top:120px" OnClick="Button1_Click"/>
        <asp:Button ID="Button2" runat="server" BackColor="White" BorderStyle="None" CssClass="auto-style1" Font-Bold="False" Font-Names="Corbel" Font-Size="Large" Font-Underline="False" ForeColor="Black" Text="Изменение личных данных" Width="220px" style="position:absolute;left:200px;top:120px" OnClick="Button2_Click"/>
        <asp:Button ID="Button3" runat="server" BackColor="White" BorderStyle="None" CssClass="auto-style13" Font-Bold="False" Font-Names="Corbel" Font-Size="Large" Font-Underline="False" ForeColor="Black" Text="Смена тарифа" Width="140px" OnClick="Button3_Click"/>
        <asp:Button ID="Button4" runat="server" BackColor="White" BorderStyle="None" CssClass="auto-style1" Font-Bold="False" Font-Names="Corbel" Font-Size="Large" Font-Underline="False" ForeColor="Black" Text="Подключение/отключение услуг" Width="265px" style="position:absolute;left:625px;top:120px" OnClick="Button4_Click"/>            
        <asp:Button ID="Button5" runat="server" BackColor="#0033CC" BorderStyle="None" CssClass="auto-style12" Font-Bold="False" Font-Names="Corbel" Font-Size="Medium" Font-Underline="False" ForeColor="White" Text="Данные договора" Width="145px" style="position:absolute;left:450px;top:170px" Visible = "false" OnClick="Button5_Click"/>            
        <asp:Button ID="Button6" runat="server" BackColor="#0033CC" BorderStyle="None" CssClass="auto-style1" Font-Bold="False" Font-Names="Corbel" Font-Size="Medium" Font-Underline="False" ForeColor="White" Text="Данные тарифа" Width="135px" Visible = "false" OnClick="Button6_Click" style="position:absolute;left:605px;top:170px"/>            
        <asp:Button ID="Button7" runat="server" BackColor="#0033CC" BorderStyle="None" CssClass="auto-style1" Font-Bold="False" Font-Names="Corbel" Font-Size="Medium" Font-Underline="False" ForeColor="White" Text="Данные услуг" Width="125px" style="position:absolute;left:750px;top:170px" Visible = "false" OnClick="Button7_Click"/>    
        <asp:Button ID="Button8" runat="server" BackColor="#0033CC" BorderStyle="None" CssClass="auto-style16" Font-Bold="False" Font-Names="Corbel" Font-Size="Medium" Font-Underline="False" ForeColor="White" Text="Изменить личные данные" Width="195px" style="position:absolute;left:650px;top:550px" Visible = "false" OnClick="Button8_Click"/>                        
        <asp:Button ID="Button9" runat="server" BackColor="#0033CC" BorderStyle="None" CssClass="auto-style1" Font-Bold="False" Font-Names="Corbel" Font-Size="Medium" Font-Underline="False" ForeColor="White" Text="Выбрать тариф" Width="170px" style="position:absolute;left:200px;top:400px" Visible = "false" OnClick="Button9_Click"/>                                
        <asp:Button ID="Button10" runat="server" BackColor="#0033CC" BorderStyle="None" CssClass="auto-style1" Font-Bold="False" Font-Names="Corbel" Font-Size="Medium" Font-Underline="False" ForeColor="White" Text="Ввести изменения" Width="170px" style="position:absolute;left:200px;top:550px" Visible = "false" OnClick="Button10_Click"/>                                
